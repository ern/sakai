var rubricsUtils = {
  ...
  initLightbox() {
    ...
    this.appendStringAsNodes(rubricsUtils.windowRef.document.body, '<div class="rubrics-lightbox" style="display:none"><div class="container"><a href="#" class=>&times;</a><sakai-rubric-student></sakai-rubric-student></div></div>');
